...
public class crearNuevoDescuentoCampoValorDescuento {
	...
	public void testGooglePage() throws InterruptedException {
		...
		driver.findElement(By.id("discountCode")).sendKeys("CODIGO2023");
		...
		Assert.assertEquals(alertMessage, "Discount code created successfully");
	}
