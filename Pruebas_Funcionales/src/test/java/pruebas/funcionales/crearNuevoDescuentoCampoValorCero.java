...
public class crearNuevoDescuentoCampoValorCero {
	...
	public void testGooglePage() throws InterruptedException {
		...
		driver.findElement(By.id("discountCode")).sendKeys("CODIGO202302");
		
		Select dropDownMenu = new Select(driver.findElement(By.id("discountType")));
		
		dropDownMenu.selectByVisibleText("Amount");
		
		driver.findElement(By.id("discountValue")).sendKeys("0");
