...
public class crearUsuarioCampoEmail {
	...
	public void testGooglePage() throws InterruptedException {
		...
		driver.findElement(By.id("userEmail")).sendKeys("andres_Gomez23@yahoo.com");
		...
		Assert.assertEquals(alertMessage, "User account inserted");
