...
import java.net.URL;
public class PruebasnombreCarrito2Test {
  ...
  @Test
  public void pruebasnombreCarrito2() {
    // Test name: Pruebas nombreCarrito 2
    ...
    // 10 | type | name=cartTitle | Ropa43@-
    driver.findElement(By.name("cartTitle")).sendKeys("Ropa43@-");
