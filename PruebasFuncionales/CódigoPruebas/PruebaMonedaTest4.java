...
import java.net.URL;
public class PruebaMoneda4Test {
  ...
  @Test
  public void pruebaMoneda4() {
    // Test name: PruebaMoneda 4
    ...
    driver.findElement(By.name("currencySymbol")).click();
    // 11 | type | name=currencySymbol | 15
    driver.findElement(By.name("currencySymbol")).sendKeys("15");
