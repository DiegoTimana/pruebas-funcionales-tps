...
import java.net.URL;
public class PruebasGeneralSettings3Test {
  ...
  @Test
  public void pruebasGeneralSettings3() {
    // Test name: Pruebas GeneralSettings 3
    ...
    // 10 | type | name=emailAddress | hi@markmoffat
    driver.findElement(By.name("emailAddress")).sendKeys("hi@markmoffat");
