...
import java.net.URL;
public class PruebasGeneralSettings6Test {
  ...
  @Test
  public void pruebasGeneralSettings6() {
    // Test name: Pruebas GeneralSettings 6
    ...
    // 10 | type | name=emailAddress | hi@
    driver.findElement(By.name("emailAddress")).sendKeys("hi@");
