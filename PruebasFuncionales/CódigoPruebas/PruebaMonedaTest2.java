...
import java.net.URL;
public class PruebaMoneda2Test {
  ...
  @Test
  public void pruebaMoneda2() {
    // Test name: PruebaMoneda 2
    ...
    driver.findElement(By.name("currencySymbol")).click();
    // 11 | type | name=currencySymbol | dola
    driver.findElement(By.name("currencySymbol")).sendKeys("dola");
