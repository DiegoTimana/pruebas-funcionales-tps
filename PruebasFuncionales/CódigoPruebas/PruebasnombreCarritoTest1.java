...
import java.net.URL;
public class PruebasnombreCarritoTest {
  ...
  @Test
  public void pruebasnombreCarrito() {
    // Test name: Pruebas nombreCarrito
    ...
    // 10 | type | name=cartTitle | Ropa
    driver.findElement(By.name("cartTitle")).sendKeys("Ropa");
