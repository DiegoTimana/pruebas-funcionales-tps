...
import java.net.URL;
public class PruebasnombreCarrito3Test {
  ...
  @Test
  public void pruebasnombreCarrito3() {
    // Test name: Pruebas nombreCarrito 3
    ...
    // 9 | click | name=cartTitle | 
    driver.findElement(By.name("cartTitle")).click();
    // 10 | type | name=cartTitle | ""
    driver.findElement(By.name("cartTitle")).sendKeys(" ");
