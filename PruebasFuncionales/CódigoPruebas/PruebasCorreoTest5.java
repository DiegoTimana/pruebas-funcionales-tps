...
import java.net.URL;
public class PruebasGeneralSettings5Test {
  ...
  @Test
  public void pruebasGeneralSettings5() {
    // Test name: Pruebas GeneralSettings 5
    ...
    // 10 | type | name=emailAddress | @markmoffat
    driver.findElement(By.name("emailAddress")).sendKeys("@markmoffat");
